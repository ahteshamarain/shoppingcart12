...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2024 at 12:47 PM
...
INSERT INTO `cart` (`cart_id`, `pro_name`, `Pro_price`, `user_id`, `pro_id`) VALUES
(1, '', 0, 0, 0),
(2, '', 0, 0, 0),
(3, 'Birthday card', 1, 0, 0),
(4, 'Birthday card', 1, 0, 0),
(5, 'The Gifting Tree', 1, 0, 0);
...
(53, 'card', 'this is use to gifts', '25', 'news-1.jpg', 'ct-61254', 5);
...
(65, 'ebad', 'uddin', 'ebad@gmailcom', '$2y$10$SS4DUQTe0//przxrXT3QLOaIVb86ZoG1BcM30gtXCZLmrIRsV7wr2'),
(66, 'umer', 'choudry', 'umar@gmail.com', '$2y$10$tH2.OH88h9ISzvrzE3KiquWAt7Gg3GvG4DYVN5NAwRODg2pH3w3YK');
...
--
ALTER TABLE `products`
  MODIFY `pid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
